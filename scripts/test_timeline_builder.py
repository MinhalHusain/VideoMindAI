"""Temporary script to test TimelineService end-to-end."""
...
def main():
    ...
    timeline_created = len(timeline) > 0

    # --- Save updated knowledge.json with timeline ---
    ...
    print()
    print(f"Timeline Created: {yes_no(timeline_created)}")
    print()
