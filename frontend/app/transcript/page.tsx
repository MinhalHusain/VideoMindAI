...
export default function TranscriptPage() {
    ...
    return (
      <div className="flex h-full flex-col items-center justify-center p-8 text-center text-muted-foreground mt-20">
        ...
        <p className="max-w-md text-sm">
          Upload a video first to view its extracted transcript.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="h-[calc(100vh-6rem)] pb-6 mx-auto w-full max-w-4xl">
      <TranscriptViewer workspaceId={activeWorkspace.videoId} />
    </div>
  );
}
